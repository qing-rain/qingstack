...
namespace Microsoft.AspNetCore.Authentication.WeChat
{
    public class WeChatAuthenticationHandler : OAuthHandler<WeChatAuthenticationOptions>
    {
        ...
        {
            if (!IsWeChatAuthorizationEndpointInUse())
            {
        ...
        private bool IsWeChatAuthorizationEndpointInUse()
        {
            return string.Equals(Options.AuthorizationEndpoint, WeChatAuthenticationDefaults.AuthorizationEndpoint, StringComparison.OrdinalIgnoreCase);
        }
    }
}
